...
import { Dimensions, View, StyleSheet, Text, TouchableOpacity, Image, ScrollView, TouchableHighlight, LayoutAnimation, Platform as Platform$1, UIManager, ImageBackground, Animated, TextInput, Modal, Alert, Switch } from 'react-native';
...
var Badge = function Badge(_ref) {
  ...
  return React.createElement(View, {
    style: StyleSheet.flatten([header, styles, bPill, shadow$1, style])
  }, icon ? null : React.createElement(Text, {
    numberOfLines: 1,
    style: text
  }, title), React.createElement(View, null, icon));
};
...
var badgeStyles = StyleSheet.create({
  pill: {
    borderRadius: 100,
    paddingRight: 4,
    paddingLeft: 4
...
function (_Component) {
  ...
  _proto.render = function render() {
    ...
    if (gradient) {
      return button = React.createElement(LinearGradient, {
        ...
        disabled: isDisabled
      }, attributes), React.createElement(Text, {
        style: StyleSheet.flatten([mainText, {
          color: textColor ? textColor : "#fff"
        }])
      }, checkTitle, " ", children)));
    } else {
      return button = React.createElement(TouchableOpacity, _extends({
...
var btnStyle = StyleSheet.create({
  defaultBG: {
...
var styles$4 = StyleSheet.create({// cardImgTop: {
  //   flex: 1
  // }
});
...
var MDBCardTitle = function MDBCardTitle(_ref) {
  ...
  return React.createElement(Text, _extends({
    style: StyleSheet.flatten([styles$7.cardTitle, style])
  }, attributes), children);
};
...
var imgStyles = StyleSheet.create({
  featured: {
...
function (_Component) {
  ...
  _proto.render = function render() {
    ...
    var mapImg = images.map(function (e, i) {
      return React.createElement(MDBImage, {
        key: i,
        source: {
          uri: e
        },
    ...
    return React.createElement(View, {
      ...
      ref: this.scrollRef
    }, mapImg), React.createElement(View, {
...
var Icon = function Icon(props) {
  ...
  return React.createElement(View, null, React.createElement(FontAwesomeIcon, attributes));
};
...
function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return React.createElement(View, {
    ...
    }, React.createElement(TouchableHighlight, _extends({}, attributes, {
      ...
      style: StyleSheet.flatten([styles$9.checkBoxLabelText, scs(labelColor, basicColors, true, ['color'])])
    }, label))));
  };
...
var MDBFooterCopyright = function MDBFooterCopyright(_ref) {
  ...
  return React.createElement(View, _extends({
    style: StyleSheet.flatten([_extends({}, styles$c.copyright), style, scs(color, basicColors, true, ['backgroundColor', 'borderColor'])])
  }, attributes), React.createElement(Text, {
    style: StyleSheet.flatten([styles$c.copyrightText, scs(textColor ? textColor : 'light', basicColors, true, ['color', 'borderColor'])])
  }, children));
};
...
function (_Component) {
  ...
  function MDBLabel() {
    ...
    _defineProperty(_assertThisInitialized(_this), "state", {
      animatedScale: new Animated.Value(_this.props.hasValue || _this.props.focused ? _this.props.labelActiveScale : 1),
      animatedTranslate: new Animated.Value(_this.props.hasValue || _this.props.focused ? _this.props.labelActiveTop : 0)
    });
...
function (_React$Component) {
  ...
  function MDBUnderline() {
    ...
    _defineProperty(_assertThisInitialized(_this), "state", {
      animatedOpacity: new Animated.Value(_this.props.error ? 1 : 0),
      animatedScaleX: new Animated.Value(_this.props.error ? 1 : 0.01)
    });
  ...
  _proto.animateDefault = function animateDefault() {
    Animated.sequence([Animated.timing(this.state.animatedScaleX, {
      duration: this.props.underlineDuration,
      toValue: 1,
      useNativeDriver: true
...
var MDBErrorMessage = function MDBErrorMessage(props) {
  ...
  return React.createElement(View, null, !!errorMessage && React.createElement(Text, {
    style: StyleSheet.flatten([styles$d.error, {
...
function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return React.createElement(View, {
    ...
    }, React.createElement(MDBLabel, pickLabelProps(_extends({}, this.props, {
      hasValue: hasValue,
      focused: focused
    }))), React.createElement(TextInput, _extends({}, pickTextInputProps(this.props), {
      ...
      value: value
    }))), React.createElement(MDBUnderline, pickUnderlineProps(_extends({}, this.props, {
      focused: focused
    }))), React.createElement(MDBErrorMessage, {
...
_defineProperty(MDBInput, "propTypes", _extends({}, propTypes$2, {}, TextInput.propTypes));
...
function (_Component) {
  ...
  _proto.render = function render() {
    ...
    var size = Image.resolveAssetSource(this.props.source);
    return React.createElement(View, {
      style: _extends({
        display: 'flex',
        flexDirection: 'row',
...
function (_Component) {
  ...
  _proto.render = function render() {
    ...
    var modal = React.createElement(View, {
      style: {
        marginTop: 22
      }
    ...
    }, React.createElement(View, null, children, React.createElement(TouchableHighlight, {
      style: {
        position: 'absolute',
        right: 0,
        top: 0
...
var MDBNavbar = function MDBNavbar(props) {
  ...
  var navbarContent = function navbarContent() {
    ...
    }, icon ? React.createElement(React.Fragment, null, React.createElement(Text, {
      style: StyleSheet.flatten([{
  ...
  if (gradient !== '') {
    return React.createElement(LinearGradient, {
      ...
      style: StyleSheet.flatten([styles$e.navbar, style])
    }, navbarContent());
  } else {
    return React.createElement(View, {
      style: StyleSheet.flatten([styles$e.navbar, dynamicColor, style])
    }, navbarContent());
  }
};
...
function (_Component) {
  ...
  _proto.render = function render() {
    ...
    var renderButtons = options.map(function (item) {
      ...
      isLeft ? isLeft = React.createElement(View, {
        key: item.key,
      ...
      }, item.text), React.createElement(TouchableOpacity, _extends({
        style: [styles$g.circle, _this2.state.value === item.key ? scs(color, basicColors, true, ['borderColor']) : null],
        onPress: function onPress() {
          return _this2.setActive(item.key);
        }
...
function (_Component) {
  ...
  _proto.render = function render() {
    ...
    }, attributes), React.createElement(Text, null, labelLeft), React.createElement(Switch, {
      value: value,
    ...
    }), React.createElement(Text, null, labelRight));
  };
...
export { Badge as MDBBadge, Button as MDBButton, ButtonGroup as MDBButtonGroup, Card as MDBCard, MDBCardBody, MDBCardFooter, MDBCardImgTop, MDBCardLink, MDBCardText, MDBCardTitle, MDBCarousel, MDBCheckbox, MDBCollapse, MDBContainer, MDBFooter, MDBFooterCopyright, Icon as MDBIcon, MDBImage, MDBImageOverlay, MDBInput, MDBMask, MDBModal, MDBNavbar, MDBNavbarBrand, MDBRadioButton, MDBSwitch, MDBTooltip };
//# sourceMappingURL=mdbreact-mobile.esm.js.map
